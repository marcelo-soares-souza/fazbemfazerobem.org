...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { descricao: @pedido.descricao, projeto_id: @pedido.projeto_id, tipo: @pedido.tipo } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { descricao: @pedido.descricao, projeto_id: @pedido.projeto_id, tipo: @pedido.tipo } }
